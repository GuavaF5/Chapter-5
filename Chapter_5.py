...
st.title("Глава 5. Финал")

st.write("Пройдя в финальную комнату, Вы встретились лицом к лицу со своим последним противником - огромным рыцарем. Но с ним что-то не так, как будто бы он вовсе не человек...")
st.write("Победите его, ответив правильно на все вопросы, но будьте аккуратны, у Вас нет права на ошибку!")

st.markdown("![Alt Text](https://steamuserimages-a.akamaihd.net/ugc/931563240045208826/4DFC86070121128883BF67B16F39C73B9F4EA6ED/?imw=512&amp;imh=512&amp;ima=fit&amp;impolicy=Letterbox&amp;imcolor=%23000000&amp;letterbox=true)")
        ...
        if selected_option == rightoption or selected_option == rightoption + (" "):
            ...
            if st.session_state.health <= 0:
                ...
                if st.session_state.current_question >= 10:
                    ...
                    st.write("Вот ваш приз, то самое **сокровище**:")
                    zzz = "D:/1010/Chapter_5/korona.png"
                    st.image(zzz, caption='Изображение сгенерированно с помощью нейросети.')
                    st.write("***Нейро-рыцарь***: Не могу поверить, что ты победил! Забирай эту корону, так и быть, но я ещё вернусь!")
